...
//    private static final int ACTIVE_DATASET_STONEANDCHIP = 0;
//    private static final int ACTIVE_DATASET_ANIMAL = 1;
//    private static final int ACTIVE_DATASET_TARMAC = 2;
    ...
    boolean mIsDataSetActive  = false;
//    int activeDataset = ACTIVE_DATASET_ANIMAL;
    ...
    private void loadTextures()
    {
    	...
    	mTextures.add(Texture.loadTextureFromApk("textures/horse.jpg", getAssets()));
    	mTextures.add(Texture.loadTextureFromApk("textures/dog.jpg", getAssets()));
    	mTextures.add(Texture.loadTextureFromApk("textures/Cat.png", getAssets()));
    	mTextures.add(Texture.loadTextureFromApk("textures/cow.png", getAssets()));
    	mTextures.add(Texture.loadTextureFromApk("textures/fish.png", getAssets()));
    	mTextures.add(Texture.loadTextureFromApk("textures/pig.png", getAssets()));
    	mTextures.add(Texture.loadTextureFromApk("textures/Tiger.jpg", getAssets()));
   ...
   /** Called when the activity will start interacting with the user.*/
    ...
    public void callToast(){
    	runOnUiThread(new Runnable() {
			...
			public void run() {
				Toast.makeText(ImageTargets.this, "button!!", Toast.LENGTH_SHORT).show();
			}
		});
    }
